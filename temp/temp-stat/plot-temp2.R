...
plot(x,temp_inst1,type="p",col="blue",ylim = c(lmin, lmax),ylab="",pch = 6, cex = .5) 
par(new = TRUE)
plot(x,temp_inst2,type="p",col="pink",ylim = c(lmin, lmax),ylab="", pch = 10, cex = .6) 
par(new = TRUE)
plot(x,temp_max,type="p",col="green",ylim = c(lmin, lmax),ylab="", pch = 14, cex = .7) 
par(new = TRUE)
plot(x,temp_min,type="p",col="red",ylim = c(lmin, lmax),ylab="", pch = 18, cex = .8) 
par(new = TRUE)
plot(x,temp_mean,type="p",col="orange",ylim = c(lmin, lmax),ylab="", pch = 22, cex = .9) 
par(new = TRUE)
