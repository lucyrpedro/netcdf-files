...
plot(x,temp_inst1,type="b",col="blue",ylim = c(lmin, lmax),ylab="",pch = 0, cex = .9) 
par(new = TRUE)
plot(x,temp_inst2,type="b",col="pink",ylim = c(lmin, lmax),ylab="", pch = 0, cex = .8) 
par(new = TRUE)
plot(x,temp_max,type="p",col="green",ylim = c(lmin, lmax),ylab="", pch = 2, cex = .7) 
par(new = TRUE)
plot(x,temp_min,type="p",col="red",ylim = c(lmin, lmax),ylab="", pch = 6, cex = .6) 
par(new = TRUE)
...
plot(xa,temp_inst1[1:100],type="b",col="blue",ylim = c(210,214),ylab="",pch = 0, cex = .5)
par(new = TRUE)
plot(xa,temp_inst2[1:100],type="b",col="pink",ylim = c(210,214),ylab="",pch = 0, cex = .5)
par(new = TRUE)
plot(xa,temp_max[1:100],type="p",col="green",ylim = c(210,214),ylab="",pch = 2, cex = .5)
par(new = TRUE)
plot(xa,temp_min[1:100],type="p",col="red",ylim = c(210,214),ylab="",pch = 6, cex = .5)
par(new = TRUE)
plot(xa,temp_mean[1:100],type="b",col="orange",ylim = c(210,214),ylab="",pch = 20, cex = .5)
par(new = TRUE)
#lines(x,temp_stdev,col="pink")
plot_colors <- c("blue","pink","green","red","orange")
par(new = TRUE)
...
plot(xb,temp_inst1[1:10],type="b",col="blue",ylim = c(210,212),ylab="",pch = 0, cex = .7)
par(new = TRUE)
plot(xb,temp_inst2[1:10],type="b",col="pink",ylim = c(210,212),ylab="",pch = 0, cex = .7)
par(new = TRUE)
plot(xb,temp_max[1:10],type="p",col="green",ylim = c(210,212),ylab="",pch = 2, cex = .7)
par(new = TRUE)
plot(xb,temp_min[1:10],type="p",col="red",ylim = c(210,212),ylab="",pch = 6, cex = .7)
par(new = TRUE)
plot(xb,temp_mean[1:10],type="b",col="orange",ylim = c(210,212),ylab="",pch = 20, cex = .7)
par(new = TRUE)
#lines(x,temp_stdev,col="pink")
plot_colors <- c("blue","pink","green","red","orange")
par(new = TRUE)
