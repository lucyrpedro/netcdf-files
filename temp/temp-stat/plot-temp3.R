...
plot(xa,temp_inst1[1:100],col="blue",ylim = c(210,214),ylab="",pch = 0, cex = .5)
par(new = TRUE)
plot(xa,temp_inst2[1:100],col="pink",ylim = c(210,214),ylab="",pch = 0, cex = .5)
par(new = TRUE)
plot(xa,temp_max[1:100],col="green",ylim = c(210,214),ylab="",pch = 2, cex = .5)
par(new = TRUE)
plot(xa,temp_min[1:100],col="red",ylim = c(210,214),ylab="",pch = 6, cex = .5)
par(new = TRUE)
plot(xa,temp_mean[1:100],col="orange",ylim = c(210,214),ylab="",pch = 20, cex = .5)
par(new = TRUE)
#lines(x,temp_stdev,col="pink")
plot_colors <- c("blue","pink","green","red","orange")
par(new = TRUE)
