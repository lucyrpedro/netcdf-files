...
plot(x,temp_inst[27649:55296],type="l",col="pink")
lines(x,temp_max,type="l",col="green",)
lines(x,temp_min,type="l",col="red")
lines(x,temp_mean,type="l",col="orange")
...
lines(x,temp_inst[27649:55296],col="pink")
