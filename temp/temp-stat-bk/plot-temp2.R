...
plot(xa,temp_inst1[1:100],type="s",col="blue",ylim = c(210,214),ylab="",pch = 6, cex = .9)
par(new = TRUE)
plot(xa,temp_inst2[1:100],type="s",col="pink",ylim = c(210,214),ylab="",pch = 10, cex = .8)
par(new = TRUE)
plot(xa,temp_max[1:100],type="p",col="green",ylim = c(210,214),ylab="",pch = 14, cex = .7)
par(new = TRUE)
plot(xa,temp_min[1:100],type="p",col="red",ylim = c(210,214),ylab="",pch = 18, cex = .6)
par(new = TRUE)
...
plot(xb,temp_inst1[1:10],type="s",col="blue",ylim = c(210,212),ylab="",pch = 6, cex = .9)
par(new = TRUE)
plot(xb,temp_inst2[1:10],type="s",col="pink",ylim = c(210,212),ylab="",pch = 10, cex = .8)
par(new = TRUE)
plot(xb,temp_max[1:10],type="p",col="green",ylim = c(210,212),ylab="",pch = 14, cex = .7)
par(new = TRUE)
plot(xb,temp_min[1:10],type="p",col="red",ylim = c(210,212),ylab="",pch = 18, cex = .6)
par(new = TRUE)
plot(xb,temp_mean[1:10],type="p",col="orange",ylim = c(210,212),ylab="",pch = 22, cex = .5)
par(new = TRUE)
#lines(x,temp_stdev,col="pink")
plot_colors <- c("blue","pink","green","red","orange")
par(new = TRUE)
