...
fd = open(filename, "w")
fields = ["SUITE", "TIME", "INITIAL", "TIME-INITIAL","TIME-INITIAL-TOOK1","ENSEMBLE", "RESOLUTION", "NODES", "JOB_SUBMIT_TIME", "JOB_INIT_TIME", "JOB_EXIT_TIME", "JOB_STATUS" , "JOB_ID", "JOB_PID", "TOOK"]
