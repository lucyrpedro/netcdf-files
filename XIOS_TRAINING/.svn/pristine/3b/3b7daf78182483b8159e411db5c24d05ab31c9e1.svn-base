...
TRY
{
  ...
  {
    if (axisDest_->value.isEmpty()) ERROR("CAxisAlgorithmInverse::CAxisAlgorithmInverse(CAxis* axisDestination, CAxis* axisSource)",
                                       << "Axis destination value is not initialized");
